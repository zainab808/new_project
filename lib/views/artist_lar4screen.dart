...
/// ---------------- MAIN SCREEN ----------------
class ArtistLar4screen extends StatefulWidget {
   
  const ArtistLar4screen({super.key});

  @override
  State<ArtistLar4screen> createState() =>
      _ArtistLar4screenState();
}

class _ArtistLar4screenState
    extends State<ArtistLar4screen> {
